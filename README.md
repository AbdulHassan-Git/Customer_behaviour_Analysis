...
# <img width="941" height="511" alt="image" src="https://github.com/user-attachments/assets/e06c8463-c15e-4fc7-8d8f-1cf275a25007" />


  
________________________________________
## 📊 Overview
This project analyses customer shopping behaviours for a retail company to identify trends, spending patterns, and loyalty drivers.
It follows a complete data analytics workflow — from data cleaning in Python, to SQL analysis, Power BI dashboard creation, and a final business report & presentation.
________________________________________
## 📁 Dataset
...
•	Executed SQL queries to answer 10+ business questions, such as:
  o	Revenue contribution by gender and age group
  o	Do subscribers spend more?
  o	Which products have the best review ratings?
  o	What are the top 3 purchased products per category?
  o	What’s the revenue contribution by age group?
4️⃣ Power BI Dashboard
•	Created an interactive dashboard summarizing:
  o	Revenue by gender, age, and product category
  o	Subscription and shipping insights
  o	Customer segmentation (New, Returning, Loyal)
  o	Top products by sales and review rating
...
6.	Review Deliverables
  o	📘 Customer_Shopping_Behaviour_Analysis_Report.docx — Project report
  o	🎞️ Customer_Behavior_Presentation.gamma — Presentation slides
________________________________________
## 🚀 Outcome
